...
class AddMondayWorkout extends StatefulWidget {
  const AddMondayWorkout({Key? key}) : super(key: key);

  @override
  _AddMondayWorkoutState createState() => _AddMondayWorkoutState();
}

class _AddMondayWorkoutState extends State<AddMondayWorkout> {
                        ...
                        child: Column(
                          children: [
                            Container(
                                ...
                                child: Text("MONDAY",style: TextStyle(fontWeight: FontWeight.bold, fontSize: 30,fontStyle: FontStyle.italic,decoration:TextDecoration.underline),)),
                            Container(
